...
public class CoupleService {
    ...
    @Transactional
    public CoupleLinkResponse sendInvite(UUID currentUserId, SendInviteRequest request) {
    ...
    @Transactional
    public CoupleLinkResponse acceptInvite(UUID currentUserId, UUID inviteId) {
    ...
    public CoupleLinkResponse activeLink(UUID currentUserId) {
    ...
    private boolean hasActiveLink(UUID userId) {
    ...
    private CoupleLinkResponse toResponse(CoupleLink link) {
        return new CoupleLinkResponse(link.getId(), link.getUser1Id(), link.getUser2Id(), link.getStatus().name(), link.getCreatedAt());
    }
}
